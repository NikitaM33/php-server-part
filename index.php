<?php
	...
	$CONNECT = mysqli_connect('localhost', 'root', '', 'portal_bd');
	...
	function Work() {
		//if ( $_SERVER['REMOTE_ADDR'] != '1212.2121.2121.212')
		if ( !in_array($_SERVER['REMOTE_ADDR'], array('1212.2121.2121.212', '212.43.231.533')) )
	...
	function password_valid() {
		if ( !preg_match('/^[A-z0-9]{6,30}$/', $_POST['password']) )
			message('Пароль указан неверно и может содеражть 6 - 30 символов A-z0-9');
