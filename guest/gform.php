<?php
	...
	if ($_POST['login_f']) {
		...
		// if ( !mysqli_num_rows(mysqli_query($CONNECT, "INSERT INTO `users` (`email`, `password`) VALUES ('".$_SESSION['confirm']['email']."', '".$_SESSION['confirm']['password']."')")))
		
		// Исправить регистрацию. Любой пароль из базы подходит под любой логин из базы
